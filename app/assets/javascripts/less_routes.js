...
function delete_logo_hotel_path(id, format, params){ var _id = less_check_parameter(id);var _format = less_check_format(format);return '/hotels' + '/' + _id + '/delete_logo' + _format +  less_params_to_query(params)}
function delete_logo_hotel_ajax(id, format, verb, params, options){ var _id = less_check_parameter(id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _id + '/delete_logo' + _format, verb, params, options)}
function setup_instructions_hotels_path(format, params){ var _format = less_check_format(format);return '/hotels' + '/setup_instructions' + _format +  less_params_to_query(params)}
function setup_instructions_hotels_ajax(format, verb, params, options){ var _format = less_check_format(format);return less_ajax('/hotels' + '/setup_instructions' + _format, verb, params, options)}
function ga_instructions_hotels_path(format, params){ var _format = less_check_format(format);return '/hotels' + '/ga_instructions' + _format +  less_params_to_query(params)}
function ga_instructions_hotels_ajax(format, verb, params, options){ var _format = less_check_format(format);return less_ajax('/hotels' + '/ga_instructions' + _format, verb, params, options)}
function ga_code_hotels_path(format, params){ var _format = less_check_format(format);return '/hotels' + '/ga_code' + _format +  less_params_to_query(params)}
function ga_code_hotels_ajax(format, verb, params, options){ var _format = less_check_format(format);return less_ajax('/hotels' + '/ga_code' + _format, verb, params, options)}
...
function search_hotel_bookings_path(hotel_id, format, params){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return '/hotels' + '/' + _hotel_id + '/bookings' + '/search' + _format +  less_params_to_query(params)}
function search_hotel_bookings_ajax(hotel_id, format, verb, params, options){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _hotel_id + '/bookings' + '/search' + _format, verb, params, options)}
function no_shows_hotel_bookings_path(hotel_id, format, params){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return '/hotels' + '/' + _hotel_id + '/bookings' + '/no_shows' + _format +  less_params_to_query(params)}
function no_shows_hotel_bookings_ajax(hotel_id, format, verb, params, options){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _hotel_id + '/bookings' + '/no_shows' + _format, verb, params, options)}
function check_ins_hotel_bookings_path(hotel_id, format, params){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return '/hotels' + '/' + _hotel_id + '/bookings' + '/check_ins' + _format +  less_params_to_query(params)}
function check_ins_hotel_bookings_ajax(hotel_id, format, verb, params, options){ var _hotel_id = less_check_parameter(hotel_id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _hotel_id + '/bookings' + '/check_ins' + _format, verb, params, options)}
...
function hotels_path(format, params){ var _format = less_check_format(format);return '/hotels' + _format +  less_params_to_query(params)}
function hotels_ajax(format, verb, params, options){ var _format = less_check_format(format);return less_ajax('/hotels' + _format, verb, params, options)}
function new_hotel_path(format, params){ var _format = less_check_format(format);return '/hotels' + '/new' + _format +  less_params_to_query(params)}
function new_hotel_ajax(format, verb, params, options){ var _format = less_check_format(format);return less_ajax('/hotels' + '/new' + _format, verb, params, options)}
function edit_hotel_path(id, format, params){ var _id = less_check_parameter(id);var _format = less_check_format(format);return '/hotels' + '/' + _id + '/edit' + _format +  less_params_to_query(params)}
function edit_hotel_ajax(id, format, verb, params, options){ var _id = less_check_parameter(id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _id + '/edit' + _format, verb, params, options)}
function hotel_path(id, format, params){ var _id = less_check_parameter(id);var _format = less_check_format(format);return '/hotels' + '/' + _id + _format +  less_params_to_query(params)}
function hotel_ajax(id, format, verb, params, options){ var _id = less_check_parameter(id);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _id + _format, verb, params, options)}
function month_hotel_inventories_path(hotel_id, year, month, format, params){ var _hotel_id = less_check_parameter(hotel_id);var _year = less_check_parameter(year);var _month = less_check_parameter(month);var _format = less_check_format(format);return '/hotels' + '/' + _hotel_id + '/inventories' + '/month' + '/' + _year + '/' + _month + _format +  less_params_to_query(params)}
function month_hotel_inventories_ajax(hotel_id, year, month, format, verb, params, options){ var _hotel_id = less_check_parameter(hotel_id);var _year = less_check_parameter(year);var _month = less_check_parameter(month);var _format = less_check_format(format);return less_ajax('/hotels' + '/' + _hotel_id + '/inventories' + '/month' + '/' + _year + '/' + _month + _format, verb, params, options)}

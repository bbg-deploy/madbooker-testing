IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "joxk00tl"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "CzhzfMH72JadwZGc6XjZ5UgQcoqop4peNI2tewsO"
  ...
  #
  config.api_key = "f8796b705c14aed8caa074d74d6eda8451e6d725"
